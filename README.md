...
This project implements an AI-based index fund that tracks the **S&P 100** using **fewer than 100 stocks**, based on the requirements of a Continuous Assessment (CA2) for the _AI-Driven Decision Making_ module (MSCAI, National College of Ireland).
